...
def heuristic_score(G, invariants, conjecture):
    ...
    # Use an inverse quadratic weight that stays near 1 for small |violation|,
    # decays smoothly. This gives gentler gradients around violation=0.
    ...
    if violation < 0:
        ...
        score += 0.8 * dir_norm * dist_factor
